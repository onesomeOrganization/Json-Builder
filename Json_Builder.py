...
#  ------ VARIABLES ------------------------------------
# Fill in:
name_of_json_file = "Test Template" # name with which you want to save the Json
...
excel_path_or_name = "Jsons/Excels/01_Templates/Json_Excel_Template5.0.xlsx" # path to the exel template
