...
#  ------ VARIABLES ------------------------------------
# Fill in:
name_of_json_file = "23_10_20_Radikale_Akzeptanz" # name with which you want to save the Json
...
version = "v"+str(83) # version of the json
...
excel_path_or_name = "Jsons/Excels/Resilienz_Radikale_Akzeptanz.xlsx" # path to the exel template
