...
#  ------ VARIABLES ------------------------------------
# Fill in:
name_of_json_file = "Kommunikation_Etappe2" # name with which you want to save the Json
...
version = "v"+str(61) # version of the json
...
etappe = 2 # usually 1 except you want to add to an existing json in a different etappe
startnumber = 1 # usually 1 except you want to add to an existing json at a different screen number
excel_path_or_name = "Jsons/Excels/Kommunikation_Etappe2.xlsx" # path to the exel template
