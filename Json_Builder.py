...
#  ------ VARIABLES ------------------------------------
# Fill in:
name_of_json_file = "23_08_09_Resilienz_komplett" # name with which you want to save the Json
...
version = "v"+str(59) # version of the json #47
...
excel_path_or_name = "Jsons/Excels/Resilienz_komplett.xlsx" # path to the exel template
