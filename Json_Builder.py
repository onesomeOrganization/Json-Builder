...
#  ------ VARIABLES ------------------------------------
# Fill in:
name_of_json_file = "Kommunikation_Etappe3" # name with which you want to save the Json
...
version = "v"+str(54) # version of the json #47
...
excel_path_or_name = "Jsons/Excels/Kommunikation_Etappe3.xlsx" # path to the exel template
