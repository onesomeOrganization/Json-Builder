...
#  ------ VARIABLES ------------------------------------
# Fill in:
name_of_json_file = "Resilienz Etappe 5" # name with which you want to save the Json
...
version = "v"+str(45) # version of the json
...
excel_path_or_name = "Jsons/Excels/Resilienz_Etappe5.xlsx" # path to the exel template
