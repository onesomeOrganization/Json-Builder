...
#  ------ VARIABLES ------------------------------------
# Fill in:
name_of_json_file = "Test: Akute Hilfe - Flora" # name with which you want to save the Json
...
version = "v"+str(77) # version of the json
...
excel_path_or_name = "Jsons/Excels/Akute Hilfe_komplett.xlsx" # path to the exel template
