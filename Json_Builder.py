...
#  ------ VARIABLES ------------------------------------
# Fill in:
name_of_json_file = "Nextlogic_Test2" # name with which you want to save the Json
...
version = "v"+str(75) # version of the json
...
excel_path_or_name = "Jsons/Excels/Nextlogic_Test.xlsx" # path to the exel template
