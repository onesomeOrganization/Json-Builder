...
#  ------ VARIABLES ------------------------------------
# Fill in:
name_of_json_file = "Test pdf" # name with which you want to save the Json
...
version = "v"+str(51) # version of the json #47
...
excel_path_or_name = "Jsons/Excels/01_Templates/features/pdf.xlsx" # path to the exel template
