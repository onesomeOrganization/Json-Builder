...
content_length_dict = {'REFERENCE': 1, 'PARAGRAPH': 1, 'EMAIL': 1, 'AUDIO': 2, 'IMAGE': 2, 'SMALL_IMAGE': 2, 'MORE_INFORMATION_EXPANDED': 1, 'MORE_INFORMATION': 1, 'SUB_TITLE': 1, 'REFERENCE': 1, 'PDF_DOWNLOAD': 2}
...
referencable_structure_content = ['ITEM(Single)', 'ITEM(Multiple)', 'SCALA', 'ANSWER OPTION', 'SEVERAL ANSWER OPTIONS', 'ANSWER OPTIONS FROM REFERENCE (Single Choice)', 'ANSWER OPTIONS FROM REFERENCE (Multiple Choice)']
